...
const commands: CommandInterface[] = [Ping, SetChannel, SubRoles, GetAddresses];
...
class Bot {
  ...
  private registerChatCommandHandler() {
    ...
    this.client.on(Events.InteractionCreate, async (interaction) => {
      ...
      console.log(
        `<@${interaction.user.id}> @${interaction.user.username}#${interaction.user.discriminator} issued command ${interaction.commandName}`,
      );
  ...
  private registerBotButtonHandler() {
    ...
    this.client.on(Events.InteractionCreate, async (interaction) => {
      ...
      console.log(
        `<@${interaction.user.id}> @${interaction.user.username}#${interaction.user.discriminator} interacted with button ${interaction.customId}`,
      );
  ...
  private registerBotModalHandler() {
    ...
    this.client.on(Events.InteractionCreate, async (interaction) => {
      ...
      console.log(
        `<@${interaction.user.id}> @${interaction.user.username}#${interaction.user.discriminator} submitted modal ${interaction.customId}`,
      );
